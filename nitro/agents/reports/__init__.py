"""
Reports Agent — Nitro MCP Module

Responsibility:
  Generates structured research reports in Markdown. Synthesizes evidence, citations, and hypotheses.
...
#
# server = NitroServer(name="reports")
#
# @server.tool(name="...")
